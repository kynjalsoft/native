...
- Staff device consent is tied to a securely stored account-to-subject association after authenticated registration. Removing an account with unreadable credentials clears its own consent; for older records with no provable association, removal also clears unowned local consent while preserving preferences proven to belong to surviving staff accounts. Affected legacy accounts must opt in again.
